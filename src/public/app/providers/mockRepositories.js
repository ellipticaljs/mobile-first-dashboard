...
/// uses elliptical.generic.repository for query operations and localStorage for persistence
...
elliptical.module = (function (app) {
    ...
    var USER_KEY=app.USER_MODEL_KEY;
    var ORDER_KEY=app.ORDER_MODEL_KEY;
    var DISCOUNT_KEY=app.DISCOUNT_MODEL_KEY;
    var USER_MODEL=null;
    var ORDER_MODEL=null;
    var DISCOUNT_MODEL=null;
    var REPOPULATE=app.REPOPULATE;
    ...
    function discountRepository(){
        ...
        repo.get=function(params,resource,query,callback){
            ...
            var code=params.id;
            var List=this.Enumerable();
            var promo=List.Where(function(x) { return x.code.toLowerCase()==code.toLowerCase()}).FirstOrDefault();
            callback(null,promo);
        };
        //handle onChange for persistence
        repo.onChange=function(model){
